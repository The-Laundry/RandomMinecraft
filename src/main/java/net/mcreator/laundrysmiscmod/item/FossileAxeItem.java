...
public class FossileAxeItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:fossileaxe")
	public static final Item block = null;
	public FossileAxeItem(LaundrysMiscModElements instance) {
		super(instance, 38);
	}
