...
public class RootIngotItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:rootingot")
	public static final Item block = null;
	public RootIngotItem(LaundrysMiscModElements instance) {
		super(instance, 78);
	}
