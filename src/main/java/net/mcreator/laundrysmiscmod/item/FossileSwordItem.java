...
public class FossileSwordItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:fossilesword")
	public static final Item block = null;
	public FossileSwordItem(LaundrysMiscModElements instance) {
		super(instance, 39);
	}
