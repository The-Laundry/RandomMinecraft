...
public class DuneSwordItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:dunesword")
	public static final Item block = null;
	public DuneSwordItem(LaundrysMiscModElements instance) {
		super(instance, 60);
	}
