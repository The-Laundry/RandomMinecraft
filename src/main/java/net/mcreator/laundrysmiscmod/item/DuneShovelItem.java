...
public class DuneShovelItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:duneshovel")
	public static final Item block = null;
	public DuneShovelItem(LaundrysMiscModElements instance) {
		super(instance, 61);
	}
