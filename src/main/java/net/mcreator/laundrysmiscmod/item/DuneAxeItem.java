...
public class DuneAxeItem extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:duneaxe")
	public static final Item block = null;
	public DuneAxeItem(LaundrysMiscModElements instance) {
		super(instance, 59);
	}
