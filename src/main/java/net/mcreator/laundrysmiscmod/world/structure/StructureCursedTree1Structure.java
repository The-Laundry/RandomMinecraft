...
public class StructureCursedTree1Structure extends LaundrysMiscModElements.ModElement {
	public StructureCursedTree1Structure(LaundrysMiscModElements instance) {
		super(instance, 119);
	}
