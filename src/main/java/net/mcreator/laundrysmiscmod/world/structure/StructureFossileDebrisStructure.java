...
public class StructureFossileDebrisStructure extends LaundrysMiscModElements.ModElement {
	public StructureFossileDebrisStructure(LaundrysMiscModElements instance) {
		super(instance, 33);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("laundrysmiscmod", "structurefossile1"));
						if (template == null)
							return false;
