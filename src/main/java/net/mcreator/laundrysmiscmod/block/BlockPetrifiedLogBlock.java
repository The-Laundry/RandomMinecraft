...
public class BlockPetrifiedLogBlock extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:blockpetrifiedlog")
	public static final Block block = null;
	public BlockPetrifiedLogBlock(LaundrysMiscModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.STONE).hardnessAndResistance(1.5f, 6f).lightValue(0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("blockpetrifiedlog");
		}
