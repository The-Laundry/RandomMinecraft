...
public class BlockLimestoneBrickWallBlock extends LaundrysMiscModElements.ModElement {
	@ObjectHolder("laundrysmiscmod:blocklimestonebrickwall")
	public static final Block block = null;
	public BlockLimestoneBrickWallBlock(LaundrysMiscModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("blocklimestonebrickwall");
		}
